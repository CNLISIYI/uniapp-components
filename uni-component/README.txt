...
2. 参数：
	- 轮播列表：Arr，轮播列表中第1行的内容。
	- 轮播列表：ArrS，轮播列表中第2行的内容。
	- 轮播列表：ArrT，轮播列表中第3行的内容。
	- 轮播列表：ArrF，轮播列表中第4行的内容。
...
3. 使用组件：
	...
	- 在data()中需要定义轮播内容数组(Arr、ArrS、ArrT、ArrF)、索引值(index)、控制变量(isaniok)和空列表数组(newList)。
	- 若只使用一个数组Arr，会出现闪动bug，所以分成4个数组单独控制。
